...
function MessageInput() {
    ...
    return (
        <div className='p-4 border-t border-slate-700/50'>
            ...
            <form onSubmit={handleSendMessage} className='max-w-3xl mx-auto flex space-x-4 mt-3'>
                ...
                }} className='flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-2 px-4' placeholder='Type your message here...' />


                <input type='file' accept='image/*' ref={fileInputRef} onChange={handleImageUpload} className='hidden' />


                <button type='button' onClick={() => fileInputRef.current?.click()} className={`bg-slate-800 text-slate-400 hover:text-slate-200 rounded-lg px-4 transition-colors ${imagePreview ? "text-cyan-500" : ""}`}>
